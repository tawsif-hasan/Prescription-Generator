...
//Prescription
$section->addText($doctor_name,array('name'=>'Tahoma','size'=>10,'color'=>'0000AA'));
$section->addText($degrees,array('name'=>'Tahoma','size'=>10,'color'=>'0000AA'));
$section->addText($designation,array('name'=>'Tahoma','size'=>10,'color'=>'0000AA'));
$section->addText($work_address,array('name'=>'Tahoma','size'=>10,'color'=>'0000AA'));
$section->addText($ex_designation,array('name'=>'Tahoma','size'=>10,'color'=>'FFAFC5'));
$section->addText($ex_work_address,array('name'=>'Tahoma','size'=>10,'color'=>'FFAFC5'));
$section->addText();
$section->addText(
  "Name: ".$name."                       "."Age: ".$age."                      "."Date: ".$date."\n",
   array('name'=>'Comic Sans MS','size'=>10));
$section->addText();
$section->addText("Chief Complaints: ".$cc1.$cc2.$cc3.$cc4.$cc5,array('name'=>'Comic Sans MS','size'=>10));
$section->addText("Examination: ".$examination,array('name'=>'Comic Sans MS','size'=>10));
$section->addText(
  "Diagnosis: ".$diagnosis,
   array('name'=>'Comic Sans MS','size'=>10)
 );
 $section->addText("                                                                      ".$med1.$strength1,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose1,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med2.$strength2,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose2,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med3.$strength3,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose3,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med4.$strength4,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose4,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med5.$strength5,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose5,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med6.$strength6,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose6,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med7.$strength7,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose7,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med8.$strength8,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose8,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                      ".$med9.$strength9,array('name'=>'Comic Sans MS','size'=>10));
 $section->addText("                                                                        "."  ".$dose9,array('name'=>'Comic Sans MS','size'=>10));
$textlines = explode("\n", $investigation);
...
$section->addText("                                                                        "."  "."Contact Number: ".$doctor_phone,array('name'=>'Arial','size'=>10));
$section->addText("                                                                        "."  "."Email Address: ".$doctor_email,array('name'=>'Arial','size'=>10));
...
//fpdf
  ...
  if (file_exists('prescription.pdf')) {
    unlink('prescription.pdf');
}
  ...
  <div class="form_div container">
    <form action="create.php" method="post" >
     ...
     <!--<input type="submit" name="download" value="Download Prescription">-->
      <!--<p>Send to:
      <input type="email" name="receiver" value="tawsifhasan@iut-dhaka.edu"></p>
